...
description: Researches domain ecosystem before roadmap creation. Produces files in .gsd/research/ consumed during roadmap creation. Spawned by /gsd:new-project or /gsd:new-milestone orchestrators.
...
Answer "What does this domain ecosystem look like?" Write research files in `.gsd/research/` that inform roadmap creation.
