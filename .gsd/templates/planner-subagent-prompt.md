...
@.gsd/phases/{phase_dir}/{phase_num}-CONTEXT.md

**Research (if exists):**
@.gsd/phases/{phase_dir}/{phase_num}-RESEARCH.md

**Gap Closure (if --gaps mode):**
@.gsd/phases/{phase_dir}/{phase_num}-VERIFICATION.md
...
<prior_state>
Phase directory: @.gsd/phases/{phase_dir}/
Existing plans: @.gsd/phases/{phase_dir}/*-PLAN.md
</prior_state>
