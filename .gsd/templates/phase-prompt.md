...
Template for `.gsd/phases/XX-name/{phase}-{plan}-PLAN.md` - executable phase plans optimized for parallel execution.
...
```markdown
<context>
@.gsd/phases/03-features/03-01-SUMMARY.md  # Just because it's earlier
@.gsd/phases/03-features/03-02-SUMMARY.md  # Reflexive chaining
</context>
```
...
<output>
After completion, create `.gsd/phases/03-features/03-01-SUMMARY.md`
</output>
```
...
@.gsd/PROJECT.md
@.gsd/ROADMAP.md
@.gsd/phases/03-features/03-01-SUMMARY.md
@.gsd/phases/03-features/03-02-SUMMARY.md
</context>
...
<output>
After completion, create `.gsd/phases/03-features/03-03-SUMMARY.md`
</output>
```
